...
```{r sol-autism-epilepsy-input, out.width='100%', fig.cap='Jamovi Eingabe.'}
...
```{r sol-autism-epilepsy-output, out.width='100%', fig.cap='Jamovi Ausgabe.'}
...
$$\phi = \sqrt{\frac{\chi^2}{n\cdot (k-1)}} = \sqrt{\frac{`r round(exm_learning_style$jmv_output_test$value_chiSq,2)`}{`r exm_learning_style$n`\cdot (3-1)}} = `r round(sqrt(round(exm_learning_style$jmv_output_test$value_chiSq,2) / (exm_learning_style$n*(3-1))),2)`$$
