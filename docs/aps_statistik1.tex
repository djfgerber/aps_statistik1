...
\begin{exercise}
\protect\hypertarget{exr:unintentional-learning}{}\label{exr:unintentional-learning}\leavevmode

Mit einer Studie soll herausgefunden werden, ob es bei der unabsichtlichen Erinnerung von Informationen einen Altersunterschied (\texttt{Age}) gibt. Dabei werden alte (\texttt{Old} 55-65 Jahre) und junge Menschen (\texttt{Young} 18-30 Jahre) Wörter gezeigt und verglichen, wie viele davon 10 Minuten später noch wiedergegeben werden können \texttt{Recall}. Die Daten sind im Datensatz \texttt{02-exr-unintentional-learning.sav} festgehalten.

\begin{enumerate}
\def\labelenumi{(\alph{enumi})}
\tightlist
\item
  Stellen Sie die Anzahl erinnerter Wörter in einem Histogramm mit dem \texttt{Jamovi} Basis-Modul dar.
\item
  Berechnen Sie alle bekannten Zentralitäts- und Variabilitätsmasse und berichten Sie mit dem korrekten Symbol mit \(2\) Nachkommastellen und mit \(3\) Nachkommastellen.
\item
  Stellen Sie die Anzahl erinnerter Wörter in einem Histogramm mit dem \texttt{JJStatsPlot}-Modul und einer Korbbreite von \(3\) erinnerten Wörtern dar. Wie viel Prozent der Menschen erinnerten sich an \(8\) bis \(10\) Wörter? Wie viele Menschen erinnerten sich an \(8\) bis \(10\) Wörter? Wieso stimmt hier die relative Häufigkeit \texttt{proportion} mit der absoluten Häufigkeit \texttt{count} überein?
\item
  Wiederholen Sie Teilaufgabe (b) aber teilen Sie die Daten nach Alter auf. Beschränken Sie sich dabei auf \(2\) Nachkommastellen. Was fällt beim Altersvergleich auf?
\end{enumerate}

\end{exercise}

\begin{solution}
Der Datensatz wird bei \texttt{Jamovi} eingelesen. Für a und b werden die Analyseparameter wie in Abbildung \ref{fig:sol-unintentional-learning-input} gesetzt.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-input} 

}

\caption{Jamovi setzen der Analyseparameter.}\label{fig:sol-unintentional-learning-input}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-output} 

}

\caption{Jamovi Ausgabe.}\label{fig:sol-unintentional-learning-output}
\end{figure}
...
\tightlist
\item
  Einmal mit \texttt{Jamovi} berechnet, können die Parameter in der \texttt{Deskriptivstatistik} abgelesen werden. Die Nachkommastellen werden bei den 3 Punkten in der Ecke oben rechts unter \texttt{Zahlenformat} eingestellt, siehe Abbildung \ref{fig:sol-unintentional-learning-input2}.
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-input2} 

}

\caption{Jamovi Einstellung Nachkommastellen.}\label{fig:sol-unintentional-learning-input2}
\end{figure}
...
\tightlist
\item
  Für c werden die Analyseparameter wie in Abbildung \ref{fig:sol-unintentional-learning-input3} gesetzt.
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-input3} 

}

\caption{Jamovi setzen der Analyseparameter.}\label{fig:sol-unintentional-learning-input3}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-output3} 

}

\caption{Jamovi Ausgabe.}\label{fig:sol-unintentional-learning-output3}
\end{figure}

Aus dem Histogramm kann am 3. Balken auf der \texttt{count}-Achse (links) respektive der \texttt{proportion}-Achse abgelesen werden, dass sich \(18\) Menschen respektive \(18\%\) der Beobachtungen an zwischen \(8\) bis \(10\) Wörter erinnern. Hier entsprechen die relative und die absolute Häufigkeit einander genau, weil genau \(N=100\) Beobachtungen vorliegen. \(18\) Beobachtungen entsprechen also \(18\%\) der Beobachtungen.
...
\tightlist
\item
  Für d werden die Analyseparameter wie in Abbildung \ref{fig:sol-unintentional-learning-input4} gesetzt.
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-input4} 

}

\caption{Jamovi setzen der Analyseparameter.}\label{fig:sol-unintentional-learning-input4}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/02-exr-unintentional-learning-jmv-output4} 

}

\caption{Jamovi Ausgabe.}\label{fig:sol-unintentional-learning-output4}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/02-exr-diverse-distrib-output} 

}

\caption{Deskriptive Statistiken.}\label{fig:sol-diverse-distrib2}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-1} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-2} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-3} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-4} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-5} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-6} \includegraphics[width=0.33\linewidth]{aps_statistik1_files/figure-latex/sol-diverse-distrib3-7} 

}

\caption{Histogramme.}\label{fig:sol-diverse-distrib3}
\end{figure}
...
Scrolle auf \href{https://seeing-theory.brown.edu/probability-distributions/index.html\#section2}{seeing-theory.brown.edu \textgreater{} Continuous \textgreater{} Normal} bis links `Central Limit Theorem' sichtbar ist.

Mit \(\alpha\) und \(\beta\) kann die Stichprobenverteilung verändert werden. Wenn \(\alpha = \beta = 1\), handelt es sich um eine Gleichverteilung, das heisst, die Beobachtungen sind auf der ganzen Breite gleich wahrscheinlich. Ein Beispiel der realen Welt dazu sind Wochentage, an welchen man krank wird. Bei \(\alpha = 2\) und \(\beta = 5\) sind Beobachtungen links viel häufiger als Beobachtungen rechts. Ein Beispiel dazu wären Geburtszeiten: Geburten sind Tagsüber viel häufiger, weil geplante Geburten (also Kaiserschnitte) auf die Frühschicht geplant werden. \texttt{Draw\ =\ 1} und \texttt{Draw\ =\ 50} bedeutet, dass eine, respektive \(50\), Stichprobe gezogen wird. \texttt{Sample\ size} ist die Stichprobengrösse.

Der zentrale Grenzwertsatz sagt nun, dass, wenn eine Stichprobe gezogen wird (Punkte fallen von der \texttt{draw} Linie runter) und der Durchschnitt davon gebildet wird (Punkte fallen auf die \texttt{average}-Linie) und dieser Prozess wiederholt wird, so sind die Durchschnitte Normalverteilt. Letzteres bedeutet, dass das Histogramm eine Glockenform hat (vergleiche mit der Linie, welche durch \texttt{Theoretical} angezeigt wird).

\begin{enumerate}
\def\labelenumi{\alph{enumi})}
\tightlist
\item
  Stelle \(\alpha = 1, \beta = 1\), \texttt{Sample\ size\ =\ 3}. Wie viele Stichprobenziehungen braucht es, damit die Durchschnitte normalverteilt aussehen?
\item
  Stelle \(\alpha = 1, \beta = 1\), \texttt{Sample\ size\ =\ 10}. Wie viele Stichprobenziehungen braucht es, damit die Durchschnitte normalverteilt aussehen?
\item
  Stelle \(\alpha = 2, \beta = 5\), \texttt{Sample\ size\ =\ 3}. Wie viele Stichprobenziehungen braucht es, damit die Durchschnitte normalverteilt aussehen?
\item
  Stelle \(\alpha = 2, \beta = 5\), \texttt{Sample\ size\ =\ 10}. Wie viele Stichprobenziehungen braucht es, damit die Durchschnitte normalverteilt aussehen?
\item
...
Die folgenden Angaben können individuell unterschiedlich ausfallen. Gründe sind die subjektive Einschätzung, ob ein Histogramm bereits wie die Normalverteilung aussieht oder nicht und der Zufall, welcher bei der Zufallsstichprobenziehung entsteht.
...
Eine Klasse bringt bei einem Biologietest eine durchwachsene Leistung, siehe \texttt{04-exr-biologietest.sav}. Die Lehrkraft entscheidet sich die genau gleichen Test zu wiederholen. Berichten Sie das durchschnittliche Resultat der beiden Tests und schätzen Sie den Einfluss der Standardabweichung auf die Länge des Konfidenzintervalls ein.
...
\caption{Verteilung der durchschnittlichen Vermögen unter der Annahme, dass die Nullhypothese wahr ist.}\label{fig:exm-vermoegen-histogram-plot}
\end{figure}
...
\caption{Oben: Histogramm der simulierten Verteilung; unten: theoretische t-Verteilung; links: Illustration p-Wert; rechts: Illustration Ablehnungsbereich. Die Linie entspricht dem beobachteten Stichprobenmittelwert. Alle Verteilungen basieren auf der Annahme, dass die Nullhypothese wahr ist.}\label{fig:exm-vermoegen-plots-sampling-theorie}
\end{figure}
...
\caption{Oben: Histogramm der simulierten Verteilung der Alexithymie-Mittelwerte; unten: theoretische t-Verteilung; links: Illustration p-Wert; rechts: Illustration Ablehnungsbereich. Die Linie entspricht dem beobachteten Stichprobenmittelwert. Alle Verteilungen basieren auf der Annahme, dass die Nullhypothese wahr ist.}\label{fig:exm-alexithymie-plot}
\end{figure}
...
\caption{Trennungsschmerz: Ablehnungsbereich und p-Wert bei wiederholter Stichprobenziehung (oben), approximiert durch den t-Test (mitte) und approximiert durch den Welch-Test (unten). Alle Ablehnungsbereiche und p-Werte sind ähnlich.}\label{fig:exm-breakup-hist-pval-reja}
\end{figure}
...
\caption{Emotionaler Stroop-Test bei PTSD: Ablehnungsbereich und p-Wert bei wiederholter Stichprobenziehung (oben), approximiert durch den t-Test (mitte) und approximiert durch den Welch-Test (unten). Der Ablehnungsbereich und p-Wert des Welch-Tests bildet die wiederholte Stichprobenziehung genauer ab im Vergleich zum t-Test.}\label{fig:exm-emotional-stroop-hist-pval-reja}
\end{figure}
...
\item
  In \texttt{Jamovi} wird für den Zweistichproben-\(t\)-Test und den Welch-Test eine unterschiedliche Effektstärke angegeben. Dies ist einigermassen seltsam, da die Effektstärke konzeptuell nicht vom Testverfahren abhängig sein sollte.
\end{itemize}
...
\begin{exercise}
\protect\hypertarget{exr:wordsrecall}{}\label{exr:wordsrecall}\leavevmode

In einem Experiment wird das Worterinnerungsgedächtnis von Patientinnen mit links (\texttt{LT\ Epilepsie})- respektive rechtsseitiger (\texttt{RT\ Epilepsie}) Temporallappenepilepsie getestet. Dazu wird eine Anzahl Wörter eingeprägt, welche die Patientinnen nach einer kurzen Zeit wiedergeben müssen und die Anzahl erinnerter Wörter wird festgehalten. Bei der Analyse mit \(t\)-Test und Welch-Test mit \texttt{Jamovi} sind die Ergebnisse in Abbildung \ref{fig:exr-wordsrecall-output} entstanden. Welche der folgenden Aussagen sind wahr, welche falsch.

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{figures/06-exr-wordsrecall-jmv-output} 

}

\caption{Jamovi Eingabe.}\label{fig:exr-wordsrecall-output}
\end{figure}
...
{\centering \includegraphics{aps_statistik1_files/figure-latex/exm-red-hair-pain-utest-order-1} 

}

\caption{Mitte: Aufsteigend sortierte Beobachtungen des Merkmals Schmerztoleranz für MC4R und Non-MC4R Mäuse. Die Zahlen stehen für die Rangnummern. Oben (MC4R) und unten (Non-MC4R) stellt die Gruppenaufteilung der Rangnummern dar.}\label{fig:exm-red-hair-pain-utest-order}
\end{figure}
...
\(N = 13\) junge mit einer Aufgeschlossenheit von \(M = 5.38, SD = 0.92\) und \(N =7\) alte mit einer Aufgeschlossenheit von \(M = 5, SD = 0.87\). Die Daten sind unter \texttt{07-exm-aufgeschlossenheit-jung-alt.sav} verfügbar. (Beispiel frei erfunden.)
\end{example}
...
{\centering \includegraphics[width=1\linewidth]{figures/07-exr-tempo30-jmv-input} 

}

\caption{Jamovi Eingabe.}\label{fig:sol-tempo30-input}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/07-exr-tempo30-jmv-output} 

}

\caption{Jamovi Ausgabe.}\label{fig:sol-tempo30-output}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/07-exr-warteschlangen-jmv-input} 

}

\caption{Jamovi Eingabe.}\label{fig:sol-warteschlangen-input}
\end{figure}
...
{\centering \includegraphics[width=1\linewidth]{figures/07-exr-warteschlangen-jmv-output} 

}

\caption{Jamovi Ausgabe.}\label{fig:sol-warteschlangen-output}
\end{figure}
...
{\centering \includegraphics[width=9.83in,height=0.5\textheight]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-input1} \includegraphics[width=9.72in,height=0.5\textheight]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-input2} 
...
{\centering \includegraphics[width=5.56in,height=0.5\textheight]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-output1} \includegraphics[width=4.06in,height=0.5\textheight]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-output2} 
...
{\centering \includegraphics[width=9.62in]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-input3} 
...
{\centering \includegraphics[width=10.03in]{figures/08-exr-ehe-burnout-pointcorrelation-jmv-output3} 
...
zusammengefasst. \phantomsection\label{customdef-vierfeldertafel}{Die \textbf{Vierfeldertafel} ist eine Kreuztabelle bei
...
Beispiel ist es der Alkoholkonsum. \phantomsection\label{customdef-risikovariable}{Dieses Merkmal wird
...
\phantomsection\label{customdef-risiko}{Mit \textbf{Risiko} wird die Wahrscheinlichkeit benannt den schädlichen
...
verglichen werden. \phantomsection\label{customdef-risikodifferenz}{Dazu kann die Differenz der beiden Risiken
sogenannte \textbf{Risikodifferenz} (in \texttt{Jamovi} unter
\texttt{Statistiken\ \textgreater{}\ Unterschiede\ in\ den\ Proportionen}) betrachtet
werden.} Wenn die
...
setzen. \phantomsection\label{customdef-tagname}{Dies wird \textbf{relatives
Risiko}}
...
\phantomsection\label{customdef-odds-ratio}{Stattdessen wird in diesen Fällen das \textbf{Chancenverhältnis} (eng. odds
ratio)}\\
...
entsprechen. \phantomsection\label{customdef-odds}{Die \textbf{Chance} (eng. odds) ist dabei eine Art
...
\section{Zusammenhang dichotomer Merkmale testen}\label{zusammenhang-dichotomer-merkmale-testen}

In \texttt{Jamovi\ \textgreater{}\ Analysen\ \textgreater{}\ Häufigkeiten\ \textgreater{}\ Kreuztabellen\ \textgreater{}\ Unabhängige\ Stichproben\ \textgreater{}\ Statistiken\ \textgreater{}\ Tests} stehen verschiedene Tests zur Verfügung, um zu testen, ob ein in einer Zufallsstichprobe
...
\subsection{\texorpdfstring{\(z\)-Test für den Unterschied zwischen den zwei Anteilen}{z-Test für den Unterschied zwischen den zwei Anteilen}}\label{z-test-fuxfcr-den-unterschied-zwischen-den-zwei-anteilen}
...
\phantomsection\label{customdef-chisq-test}{Der \(\chi^2\)-Test (sprich `chi-quadrat-test') ist eine zweite
...
Der \phantomsection\label{customdef-vierfeldertest}{\textbf{\(\chi^2\)-Vierfeldertest}}
...
\(\chi^2\)-Verteilung bei \(df = 1\) Freiheitsgraden folgt. \phantomsection\label{customdef-chisq-distribution}{Die
...
\phantomsection\label{customdef-cramers-phi}{Um die Effektstärke des \(\chi^2\)-Tests anzugeben kann \textbf{Cramérs \(\phi\)}}
...
abhängig. \phantomsection\label{customdef-vierfelderkorrelation}{Da dies auch als Zusammenhangsmass gesehen werden kann wird
...
ist, dass insgesamt \(40\) oder mehr Beobachtungen vorliegen müssen. \phantomsection\label{customdef-chisq-corrected}{Ist
...
{\centering \includegraphics[width=4.89in]{figures/09-exm-red-white-wine-aggdata-view} 
...
{\centering \includegraphics[width=4.79in]{figures/09-exm-red-white-wine-aggdata-view-alt} 
...
auch einen \(p\)-Wert dar. \phantomsection\label{customdef-fisher-yates}{Der dazugehörige Test wird \textbf{exakter Test nach
...
\item
  ...
  gemacht werden, weshalb diese Art Test auch \textbf{asymptotisch} genannt
...
{\centering \includegraphics[width=6.58in]{figures/09-exr-autism-epilepsy-jmv-input} 
...
{\centering \includegraphics[width=6.86in]{figures/09-exr-autism-epilepsy-jmv-output} 
...
{\centering \includegraphics[width=6.78in]{figures/09-exr-depression-training-jmv-input} 
...
{\centering \includegraphics[width=6.69in]{figures/09-exr-depression-training-aggdata-view} \includegraphics[width=5.11in]{figures/09-exr-depression-training-jmv-output} 
...
{\centering \includegraphics[width=6.67in]{figures/09-exr-cancer-smoking-jmv-input} 
...
{\centering \includegraphics[width=4.99in]{figures/09-exr-cancer-smoking-jmv-output} 
...
{\centering \includegraphics[width=8.28in]{figures/09-exr-bio-milch-jmv-input} 
...
{\centering \includegraphics[width=6in]{figures/09-exr-bio-milch-jmv-output} 
...
{\centering \includegraphics[width=8.01in]{figures/09-exr-covid-atemnot-jmv-input} 
...
{\centering \includegraphics[width=7.03in]{figures/09-exr-covid-atemnot-jmv-output} 
...
{\centering \includegraphics[width=6.81in]{figures/10-exm-learning-style-data-view} 
...
{\centering \includegraphics[width=8.21in]{figures/10-exm-learning-style-data-view-rel} 
...
{\centering \includegraphics[width=8.15in]{figures/10-exm-learning-style-data-view-expected} 
...
Der \phantomsection\label{customdef-mehrfeldertest}{\textbf{\(\chi^2\)-Mehrfeldertest}} trägt dem Rechnung, indem die Teststatistik diese Differenz der erwarteten und beobachteten Anzahl austariert und für jede Zelle aufsummiert mit
...
\phantomsection\label{customdef-cramers-v}{Um die Effektstärke des \(\chi^2\)-Tests anzugeben kann \textbf{Cramérs V}}
...
\(\chi^2 (4) = 12.78, p = .012, V = 0.21\). Der Zusammenhang ist als mittel einzustufen.
\end{quote}
...
\section{Übungen}\label{uxfcbungen-7}
...
{\centering \includegraphics[width=6.46in]{figures/10-exr-edu-heredity-jmv-input} 
...
{\centering \includegraphics[width=7.51in]{figures/10-exr-edu-heredity-jmv-output} 
...
{\centering \includegraphics[width=8.92in]{figures/10-exr-taste-color-jmv-input} 
...
{\centering \includegraphics[width=8.72in]{figures/10-exr-taste-color-jmv-output} 
...
{\centering \includegraphics[width=7.68in]{figures/10-exr-memory-strategy-jmv-input} 
...
{\centering \includegraphics[width=6.32in]{figures/10-exr-memory-strategy-jmv-output} 
