...
\caption{\label{fig:srs-intervall-nocol}Personen ohne Angst.TODO, make points black in population.}
\end{figure}
...
\caption{\label{fig:srs-intervall-high-p}Population mit ähnlichen Werten wie in der Stichprobe.}
\end{figure}
...
\caption{\label{fig:srs-intervall-low-p}Population mit höheren Werten als in der Stichprobe.}
\end{figure}
