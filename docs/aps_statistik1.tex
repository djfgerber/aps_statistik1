...
\section{Mittelwertunterschied einer intervallskalierten Variable}\label{mittelwertunterschied-einer-intervallskalierten-variable}
...
\protect\hypertarget{exm:breakup}{}\label{exm:breakup}\includegraphics{aps_statistik1_files/figure-latex/exm-breakup-1.pdf}

\citet{morris2015} haben untersucht, ob das Geschlecht einen Einfluss auf den Schmerz bei der Auflösung einer romantischen Beziehung hat. Die Autoren unterscheiden dabei zwischen emotionaler und physischer Reaktion. Hier wird nur auf erstere Fokusiert, welche mit \emph{ER} abgekürzt wird. Dazu wurde mit erlösfreien Online-Umfragen unter anderem erfragt, ob die Person eine Trennung erlebt hat und wie sie ihren emotionalen Trennungsschmerz von \(0\) (keine Schmerzen) bis \(10\) (unerträglich) einstuft. An der Studie haben \(N_\text{Mann} = 2695\) Männer und \(N_\text{Frau} = 1409\) Frauen mitgemacht.
\end{example}
...
\caption{\label{fig:exm-breakup-bagplot}TODO.}
\end{figure}
