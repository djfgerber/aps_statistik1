...
\item
  Stellen Sie die Anzahl erinnerter Wörter in einem Histogramm mit dem \texttt{JJStatsPlot}-Modul und einer Korbbreite von \(3\) erinnerten Wörtern dar. Wie viel Prozent der Menschen erinnerten sich an \(8\) bis \(10\) Wörter? Wie viele Menschen erinnerten sich an \(11\) bis \(13\) Wörter?
\item
...
Aus dem Histogramm kann am 3. Balken auf der \texttt{count}-Achse (links) abgelesen werden, dass \(20\) Menschen sich an zwischen \(11\) und \(13\) Wörter erinnern. Der Anteil Menschen, welcher sich an \(8\) bis \(10\) Wörter erinnert liegt bei \(18\%\), was beim 4. Balken von der \texttt{proportion}-Achse (rechts) abgelesen werden kann.
