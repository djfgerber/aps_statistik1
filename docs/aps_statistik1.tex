...
\caption{\label{fig:exm-angst-normal-approx}Die arithmetischen Mittel sind Normalverteilt mit Parametern \(\mu_g = 30\) und \(\sigma_g = 10 / \sqrt{30}\).}
\end{figure}

\begin{figure}
\centering
\includegraphics{aps_statistik1_files/figure-latex/exm-agreableness-normal-approx-1.pdf}
\caption{\label{fig:exm-agreableness-normal-approx}Die arithmetischen Mittel sind Normalverteilt mit Parametern \(\mu_g = 4\) und \(\sigma_g = 1.73 / \sqrt{100}\).}
\end{figure}
...
\midrule
Angst & 26.5 & 33.6 & 26.42 & 33.58 & 26.27 & 33.73\\
Vertraeglichkeit & 3.7 & 4.3 & 2.66 & 3.34 & 2.66 & 3.34\\
\bottomrule
\end{tabular}
\end{table}
...
In Beispiel \ref{exm:angst}, kann aus der Tabelle \ref{tab:quantiles-norm} entnommen werden, dass die Angst in der Population bei \(M = 30\) \(95\%\)-KI \([26.27,33.73]\) liegt. In Beispiel \ref{exm:agreableness}, kann aus der Tabelle \ref{tab:quantiles-norm} entnommen werden, dass die Angst in der Population bei \(M = 3\) \(95\%\)-KI \([2.66,3.34]\) liegt.
...
\section{Wo liegt der Durchschnit der Standardabweichung?}\label{wo-liegt-der-durchschnit-der-standardabweichung}

\section{Übungen}\label{uxfcbungen-1}

\begin{exercise}
\protect\hypertarget{exr:ki-mean-n-vary}{}\label{exr:ki-mean-n-vary}TODO
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:ki-mean-s-vary}{}\label{exr:ki-mean-s-vary}TODO
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:ki-approx-normal}{}\label{exr:ki-approx-normal}TODO
\end{exercise}
