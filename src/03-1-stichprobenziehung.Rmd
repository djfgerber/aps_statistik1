...
```{r srs-intervall-nocol, echo = FALSE, fig.cap="Personen ohne Angst.TODO, make points black in population."}
set.seed(124)
scores_hover <- rnorm(30, 43.2, 7.8)
plot_ball_bag(scores_bag = c(20, 80, rnorm(198, 43.2, 7.8)), 
...
Es könnte aber auch sein, dass die Stichprobe einer Population mit viel höherer Zusatandsangst, wie in Abbildung \@ref(fig:srs-intervall-low-p) dargestellt, entstammt.

```{r srs-intervall-low-p, fig.cap="Population mit höheren Werten als in der Stichprobe.", echo = FALSE}
plot_ball_bag(scores_bag = c(20, 80, rnorm(198, 52, 7.8)), 
                  scores_hover = scores_hover,
                  score_name = "Zustandsangst", 
                  seed = 123)
```
